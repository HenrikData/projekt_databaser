...
CREATE TABLE Payment (
		...
		PaymentStatus ENUM('Pending', 'Paid', 'Refunded') NOT NULL DEFAULT 'Pending', -- Pending innebär pågående
...
/*Visa hur många bokningar varje kund gjort*/
...
/*Prova att lägga in ett datum där utcheckning är mindre än incheckning*/
INSERT INTO Booking (GuestID, RoomID, CheckinDate, CheckoutDate ) VALUES
(1, 1, '2025-03-18', '2025-03-01');  
...
/*Trigger som loggar ändringar i bokningsloggen*/
DELIMITER $$
...
/*Sparad procedur "ankomstlista "för att visa ankomstlista för ett valfritt datum*/
DELIMITER $$
